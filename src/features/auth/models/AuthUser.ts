...
/** Admins are implicitly active regardless of the stored flag. */
...
/**
 * Effective permissions for a user: the base role's default set unioned with any
 * custom-role permissions. Keeps the rigid roles working while allowing overlays.
 */
